...
; Taken from https://www.autohotkey.com/boards/viewtopic.php?t=126656
; Removed Default Double-Alt shortcuts
; Added Doublt-Alt + Left Button: Drag to resize
; This makes it easier on trackpads that don't detect two finger
; right-click until release.
;
...
;  Double-Alt + Left Button   : Drag to resize a window.
;
